...
const MostReportedNfts = () => {
  ...
  const columnActivityTable = [
...

    {
      ...
      Cell: (tableProps) => (
        <>
          {tableProps.row.original.activityStatus ? (
            <div className="activeStatus">
              ...
              <p className="font-16">Active </p>
            </div>
          ) : (
            <div className="suspendedStatus">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="6"
                height="6"
                ...
                fill="none"
              >
                <circle cx="3" cy="3" r="3" fill="#E84D3C" />
              </svg>
              <p className="font-16">Suspended</p>
            </div>
          )}
        </>
      ),
...

    {
      ...
      accessor: "reportedNumber",
      Cell: (tableProps) => (
        <p className="text-danger font-14">
          {tableProps.row.original.reportedNumber}
        </p>
      ),
    },
...
export default MostReportedNfts;
